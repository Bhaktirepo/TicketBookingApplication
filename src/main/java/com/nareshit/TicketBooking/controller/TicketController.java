...
public class TicketController {
	/*
	 * 
	 * Introduction about Rest Services ==> Cross Language Communication JSON Object
	 * is the preferred mode for data communication JSON ==> Javascript Object
	 * Notation products={ "productName":"TV", "price":10000 "qty":100
	 * 
	 * }
	 * 
	 * JAVA Created JAX RS Framework for implementing REST SERVICES Spring Boot has
	 * taken same framework and customized some of the APIs If we did not speicify
	 * any verb ==> Default Get
	 * 
	 * As part of JAX RS ==> @GET ==> @GET + @REQUESTMAPPING ==> @GETMAPPING
	 * ==> @POST ==> @POST + @REQUESTMAPPING ==> @POSTMAPPING ==> @PUT ==> @PUT
	 * + @REQUESTMAPPING ==> @PUTMAPPING ==> @DELETE==> @DELETE + @REQUESTMAPPING
	 * ==> @DELETEMAPPING
	 * 
	 * 
	 * Controller ==> Entry Point from all FE to access any type of data or else to
	 * submit data RestController ===> Thru REST Protocol
	 */
	...
	/*
	 * 
	 * http://localhost:8080 ===> Bootstrap Class http://localhost:8080/tickets ==>
	 * TicketController Layer ==> obj will initialized
	...
	@GetMapping(value = "/{ticketId}") // http://localhost:8080/tickets/1
	...
	@PutMapping(value = "/{ticketId}/{newEmail}") // http://localhost:8080/tickets/1/new@gmail.com
