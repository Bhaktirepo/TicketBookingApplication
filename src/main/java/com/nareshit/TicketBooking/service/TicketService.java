 ...
 * 
 * It will automatically takes care of transaction management and we can connect
 * to any other frameworks like KAFKA,JAX WS, RABBITMQ,JMS
 */
public class TicketService {
	...
	public Ticket createTicket(Ticket inputObj) {
		...
		/*
		 * 
		 * Save method is for both insert and update based on the inputdata if inputObj
		 * does not have any ticketId ===> if inputObj.getTicketId == null ==> Insert if
		 * inputObj have any ticketId ===> if inputObj.getTicketId != null==> But this
		 * value not there in DB ==> Insert if inputObj have any ticketId ===> if
		 * inputObj.getTicketId != null==> But this value there in DB ==> update
		 * 
		 * 
		 */
